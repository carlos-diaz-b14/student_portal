function checkPassword(){
       if(document.getElementById('password').value == 'sdms'){
          ...
          document.location.href = "student/dms/main.php";

        } else if (document.getElementById('password').value == 'smgt') {
           
          document.location.href = "student/mgt/main.php";
         } else if (document.getElementById('password').value == 'swmad') {
           
          document.location.href = "student/wmad/main.php";
        } else {
