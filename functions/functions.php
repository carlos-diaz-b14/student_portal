            ...
            <ul class="nav navbar-nav mainMenu">
              <li>
                ...
                <ul class="subMenu homeSubMenu">
                  <li><a href="home/career.php">Career Prep</a></li>
                  <li><a href="home/orientations.php">Co-op Orientation</a></li>
                  <li><a href="home/term.php">Co-op Term</a></li>
                  <li><a href="home/graduation.php">Graduation</a></li>
                </ul>
              </li>
              <li>
                <a href="docs/docs.php" class="requiredDoc">Required Docs</a>
